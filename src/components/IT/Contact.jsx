    ...
    <section className="contact style-2 bg-darkBlue pt-50">
      <div className="container">
        <div className="content text-center text-white">
          <p className="op-7 mb-70 text-uppercase">
            Let us opportunity to help you!
          </p>
          <h2 className="ltspc-20 text-uppercase fs-1 lh-1 mb-50">
            +91 76666 28000
          </h2>
          <h4 className="fw-normal mb-20 op-9"> sazsapps@gmail.com</h4>
          <h4 className="fw-normal mb-30 op-7">
            8D, Arunachalam Pettai Street, Kovilpatti, Tuticorin Dist, Tamil
            Nadu, India
          </h4>
