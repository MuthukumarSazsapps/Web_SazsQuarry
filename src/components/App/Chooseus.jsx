    ...
    >
      <div className="container">
        <div className="section-head mb-30 text-center">
          <h2 className="text-black ltspc-20 text-uppercase fs-1 lh-1 mb-70">
        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="img pe-lg-5">
              ...
              {/* <img src="/assets/img/choose_us/5665295_57810.jpg" alt="" /> */}
            </div>
          </div>
          <div className="col-lg-6">
            <div className="info">
              <p className="text-uppercase mb-60">
              ...
              <ul>
                {chooseUsData.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="inf">
                      <h5 className="text-black text-capitalize mb-2">
                        {item.title}
                      </h5>
                      <small className="text-black op-8">
                        {typeof item.desc === "string" ? (
                          item.desc
                        ) : (
                          <>
                            {item.desc.desc1} <br /> {item.desc.desc2} <br />
                            {item.desc.desc3}
                          </>
                        )}
                      </small>
